  ...
  return (
    <section className="contact" id="contact">
        ...
        <div className="contact__sections">          
            <form ref={form} onSubmit={handleSubmit} className={isVisible ? "contact__form show":"contact__form hidden-right"}>
          ...
          <div ref={form} className={isVisible ? "contact__links show":"contact__form hidden-left"}>
